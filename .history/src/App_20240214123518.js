...
const App = () => {
  ...
  const [numericColumn, setNumericColumn] = useState("Numeric Value");
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setData(response.data || []); // Ensure that response.data is an array or default to an empty array
  ...
  const handleCheckBoxChange = (id) => {
    ...
    console.log("chekced",updatedData)
    setSelectedRows(
